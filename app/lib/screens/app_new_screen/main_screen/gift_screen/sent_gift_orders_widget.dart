...
class SentGiftOrdersWidget extends StatefulWidget {
  const SentGiftOrdersWidget({super.key});

  @override
  State<SentGiftOrdersWidget> createState() => _SentGiftOrdersWidgetState();
}

class _SentGiftOrdersWidgetState extends State<SentGiftOrdersWidget> {
  final currencyFormatter = NumberFormat();

  Stream<List<GiftOrder>> _getSentGiftOrders() {
    ...
    return FirebaseFirestore.instance
        ...
        .where('sender.uid', isEqualTo: currentUser.uid)
              ...
              return GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    CupertinoPageRoute(
                      builder: (context) => SentGiftOrderDetailScreen(
                        giftOrder: giftOrder,
