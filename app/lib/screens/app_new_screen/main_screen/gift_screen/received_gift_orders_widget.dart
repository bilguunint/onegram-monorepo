                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                "Танд ${giftOrder.sender.phone} утасны дугаартай ${giftOrder.sender.fullName}-с ${giftOrder.quantity}${giftOrder.metalId == 1 ? 'гр алт' : 'лан мөнгө'} бэлэг болгон илгээсэн байна.",
