...
export class TopbarComponent implements OnInit {
  ...
  adminName: string = 'Admin'; // Admin нэр
  ...
  ngOnInit() {
    ...
    // Firebase auth state шалгаж админы мэдээлэл авах
  ...
  async getCurrentAdminInfo() {
    try {
      console.log('getCurrentAdminInfo дуудагдлаа');
      ...
      if (currentUser) {
        ...
        if (adminDoc.exists) {
          ...
          console.log('Admin document олдсонгүй');
          this.adminName = 'Admin';
        }
      } else {
        console.log('Current user байхгүй');
        this.adminName = 'Admin';
      }
    } catch (error) {
      console.error('Admin мэдээлэл авахад алдаа:', error);
      this.adminName = 'Admin';
    }
  }
